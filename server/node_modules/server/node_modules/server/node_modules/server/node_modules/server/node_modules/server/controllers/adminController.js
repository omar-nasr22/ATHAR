...
exports.createBook = async (req, res) => {
  try {
    const { title, titleArabic, description, descriptionArabic, price, benefits, benefitsArabic, included, includedArabic } = req.body;
    const book = new Book({
...
exports.updateBook = async (req, res) => {
  try {
    ...
    // Update logic here... (Simplified for this task)
    Object.assign(book, req.body);
    if (req.files && req.files.coverImage) book.coverImage = req.files.coverImage[0].path;
    if (req.files && req.files.pdfFile) book.pdfFile = req.files.pdfFile[0].path;
